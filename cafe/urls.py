...
from .views import terminal_login, terminal_main, update_terminal
...
urlpatterns = [
    ...
    path('terminal/<terminal_name>/<cafe_id>', terminal_main),
    # Dynamic Terminal Routes
    path('terminal/update', update_terminal),
